...
[![Go Reference](https://pkg.go.dev/badge/latere.ai/x/pkg/typesafeai.svg)](https://pkg.go.dev/latere.ai/x/pkg/typesafeai)
...
```sh
go get latere.ai/x/pkg/typesafeai
```
